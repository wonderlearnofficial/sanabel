const ar = {
  translation: {
    ...
    networkError: "تعذر الوصول إلى السيرفر. تحقق من اتصالك بالإنترنت وحاول مرة أخرى.",
    ...
    "ادخل كود دعوة الطفل": "ادخل كود دعوة الطفل",
    ...
    "admin.toast.classNameGradeOrgRequired": "اسم الفصل والمرحلة والمدرسة مطلوبة",
    ...
    "admin.import.officialDetected": "تم اكتشاف القالب الرسمي — لا حاجة للتعيين",
